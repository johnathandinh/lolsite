...
class MatchFilter extends Component {
    ...
    getFilterParams() {
        ...
        if (this.state.start_date !== '') {
            try {
                data.start_date = this.state.start_date.toISOString()
            } catch (error) {}
        }
        if (this.state.end_date !== '') {
            try {
                data.end_date = this.state.end_date.toISOString()
            } catch (error) {}
        }
        if (champ_key !== null) {
            ...
            <div>
                <div>
                            ...
                            <div className={`input-field ${theme}`}>
                                ...
                                >
                                    {[{name: 'any', id: ''}]
                                        ...
                                        .map((queue, key) => {
                                            return (
                                                <option key={`${queue.id}-${key}`} value={queue.id}>
                                                    {queue.name}
                                                </option>
                                            )
                                        })}
                    ...
                    <div className="row">
                        <div className="col s12">
                            <button onClick={this.openModal} className={`${theme} btn-small`}>
                                More Filters
                            </button>{' '}
                            <button
                ...
                >
                    ...
                    <div style={{width: '100%'}}>
                        <div className="row" style={{marginTop: 40}}>
                            <div className="col s12">
                                <ReactTooltip id={`summoner-filter-tooltip`} effect="solid">
                                    <span>
                                        Many summoner names may be entered, separated by a comma.
                                    </span>
                                </ReactTooltip>
                                <div
                                    data-tip
                            ...
                            <div className="col s6">
                                <ReactTooltip id={`start-datetime-tooltip`} effect="solid">
                                    <span>Start Date</span>
                                </ReactTooltip>
                                <div
                                    data-tip
                                    data-for="start-datetime-tooltip"
                                    id="start-datetime-div"
                                    className="input-field"
                                >
                                    <Datetime
                            ...
                            <div className="col s6">
                                <ReactTooltip id={`end-datetime-tooltip`} effect="solid">
                                    <span>End Date</span>
                                </ReactTooltip>
                                <div
                                    data-tip
                                    data-for="end-datetime-tooltip"
                                    id="end-datetime-div"
                                    className="input-field"
                                >
                                    <Datetime
                        ...
                        <div>
                            <button onClick={this.apply} className={`${theme} btn-small`}>
                                Apply Filters
                            </button>
                        </div>
                    </div>
